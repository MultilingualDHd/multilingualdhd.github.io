...
Vor diesem Hintergrund setzt sich die AG mit drei grundlegenden Themenbereichen dazu auseinander und behandelt

1.  allgemeine Fragen zur Mehrsprachigkeitsdefinitionen in den DH, darunter auch Fragen zum Verhältnis von Programmiersprachen und natürlichen Sprachen,
2.  das Verhältnis von Einsprachigkeit und Mehrsprachigkeit in Wissenschaftsinfrastrukturen,
3.  sowie konkrete Probleme aus der mehrsprachigen, digitalen Praxis.
...
Die formale Mitgliedschaft ist an eine Mitgliedschaft in im Verband DHd geknüpft. Bitte kontaktieren Sie eine_n der Convenors

## Zentrale Ressourcen

Die Informations- und Kommunikationskanäle haben wir im ersten Jahr der AG wie folgt gebündelt

- Für die **Dokumentation** unserer Arbeit nutzen wir ein [öffentliches **Wiki**](https://projects.academiccloud.de/projects/wiki-der-dhd-ag-multilingual-dh/). Dieses wird nach Umzügen von [DARIAHs Confluence-Instanz](https://wiki.de.dariah.eu/display/AMD) zu [GitHub](https://github.com/M-L-D-H/DHd-AG/wiki/) auf einer von der GWDG bereitgestellten OpenProject Instanz betrieben.
- Für die **Kommunikation** mit der Öffentlichkeit und potentiellen neuen Mitgliedern haben wir eine kleine [**Webseite**](https://multilingualdhd.github.io) aufgesetzt, die über GitHub Pages direkt aus einem [GitHub Repositorium](https://github.com/multilingualdhd/multilingualdhd.github.io/) gehostet wird. Außerdem hat die AG eine Präsenz auf der [DHd Webseite](https://dig-hum.de/ag-multilingual-dh).
...
- Für die **Verteilung** von AG-relevanten **Informationen** gibt es
  - eine [**Mailingliste**](applewebdata://B51E3A6F-9622-4B15-8C36-E356A4F7EC25/dhd-ag-multilingual-dh@lists.digitalhumanities.org), die auch nicht-Mitgliedern offensteht,
  - ~~einen [Twitter-Account](https://twitter.com/AGMLDH) und~~
  - einen [Mastodon-Account](https://fedihum.org/@mldh).
...
- Zur Erfassung von für das Thema relevanter Literatur führen wir eine gemeinsame **Bibliographie** als öffentlich einsehbare [Zotero Gruppe](https://www.zotero.org/groups/4583441/dhd_ag_multilingual_dh).
...
E-Mail: <till.grallert@hu-berlin.de>
